"""
📊 KPI Schemas para v2 - Validación financiera con Pydantic
"""
...
class KPICalcularSchema(BaseModel):
    """
    Schema base para KPI Calcular - Validación de datos financieros
    """
...
class KPIAcumuladoCalcularSchema(BaseModel):
    """
    Schema extendido para reportes acumulados (tipo_reporte = 0)
    Incluye campos adicionales para análisis detallado
    """
