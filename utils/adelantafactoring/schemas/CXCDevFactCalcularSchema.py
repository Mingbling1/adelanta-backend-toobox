...
class CXCDevFactCalcularSchema(BaseModel):
    IdLiquidacionDevolucion: int = Field(..., description="ID de liquidación de devolución")
    ...
    ObservacionDevolucion: Optional[str] = Field(None, description="Observación de devolución")
